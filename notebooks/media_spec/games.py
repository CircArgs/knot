...
Self-contained sub-spec (``games_subspec``). Shares ``person`` from
...
igdb = games_subspec.add_source("igdb")
giant_bomb = games_subspec.add_source("giant_bomb")
steam = games_subspec.add_source("steam")
